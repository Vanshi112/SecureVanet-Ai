...
class SequenceGeneratorV2:
    ...
    def load_recordings(self):
        ...
        for file in csv_files:
            ...
            if self.feature_columns is None:
                train_df_cols = pd.read_csv('datasets/processed/engineered_normal.csv', nrows=1)
                self.feature_columns = [c for c in train_df_cols.columns if c not in ['label', 'attack_type', 'timestamp']]
    ...
    def run(self):
        print('\n' + '=' * 70)
        print('Generating OTIDS Sequences')
        print('=' * 70)
        self.load_recordings()
        print('\nLoading trained feature scaler...')
        scaler_path = Path('datasets/sequences/feature_scaler.pkl')
        ...
        self.save_dataset()
        print('\n' + '=' * 70)
        print('OTIDS sequence generation completed successfully.')
        print('=' * 70)
if __name__ == '__main__':
    INPUT_DIR = 'datasets/processed_otids'
    OUTPUT_DIR = 'datasets/otids_sequences'
